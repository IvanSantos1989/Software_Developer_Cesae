...
struct AddEditTaskView: View {
    ...
    private let symbols = ["book.fill","laptopcomputer","gamecontroller.fill","heart.fill","star","tray.fill","hammer.fill","cart.fill"]
    ...
    private func save() {
        let new = TaskItem(id: existing?.id ?? UUID(), title: title, details: details, category: category, imageName: imageName)
